...
const SnapchatIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M8 13c-.56 0-1.06.46-1.37.83-.61.8-2.72.86-2.82.86-.19.01-.34.17-.32.36.01.14.12.26.26.3 1.13.24 1.72.61 1.88.75.31.25.39.74.41.85.02.13.13.22.25.22H8m8-4c.56 0 1.06.46 1.37.83.61.8 2.72.86 2.82.86.19.01.34.17.32.36-.01.14-.12.26-.26.3-1.13.24-1.72.61-1.88.75-.31.25-.39.74-.41.85-.02.13-.13.22-.25.22H16M8 17h8m-4-4.5L14 13m-4 0 2-.5V15m0-11c-4.17 0-7.37 4.17-7.5 7.5a10.95 10.95 0 0 0 4.66 9.06A8.54 8.54 0 0 0 12 21.5a8.54 8.54 0 0 0 3.84-1.44A10.95 10.95 0 0 0 19.5 11.5C19.37 8.17 16.17 4 12 4Zm-2.5 8.5 .5-.5 2 .5 2-.5.5.5" />
  </svg>
);

const TikTokIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 256 256" fill="currentColor">
    <path d="M180 45.7V136a53.33 53.33 0 1 1-53.3-53.3 8 8 0 0 1 0 16A37.3 37.3 0 1 0 164 136V32a8 8 0 0 1 16 0c0 13.9 9.1 25.5 20 25.5a8 8 0 0 1 0 16c-14.2 0-27.7-10.2-32-27.8ZM192 16a8 8 0 0 0-8 8v120a45.3 45.3 0 1 1-27.6-41.2 8 8 0 0 0 7.2-14.4A61.34 61.34 0 1 0 200 144V24a8 8 0 0 0-8-8Z"/>
  </svg>
);
